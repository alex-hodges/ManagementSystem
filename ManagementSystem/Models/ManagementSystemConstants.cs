...
{
    public class ManagementSystemConstants
    {
        public const int MAX_COUNTY_NAME_LENGTH = 50;
        ...
        public const int MAX_POSTCODE_LENGTH = 9;
        public const int MIN_POSTCODE_LENGTH = 7;
